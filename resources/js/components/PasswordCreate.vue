<template>
<div class="c-create-popup" :style="[currentDisplay ? {display: 'block'} : {display: 'none'}]">
        ...
        <div class="card-body">
             <form method="POST" action="" @submit.prevent="createPassword">
                ...
                <div class="form-group row">
                    <label for="password_name" class="col-md-4 col-form-label text-md-right">Name</label>
                    <div class="col-md-8">
                        <input id="password_name" type="text" class="form-control" name="password_name" required  v-model="form.name">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input id="password_email" type="text" class="form-control" name="password_email" v-model="form.email">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="password_login" class="col-md-4 col-form-label text-md-right">Login</label>
                    <div class="col-md-8">
                        <input id="password_login" type="text" class="form-control" name="password_login"  v-model="form.login">
                    </div>
                </div>
